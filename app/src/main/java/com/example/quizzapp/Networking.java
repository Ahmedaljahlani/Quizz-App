...
//                    questionNumber.setText("Question Attempted:" + questionAttempted + "/10");
                    ...
                    Toast.makeText(Networking.this, "No passed Questions" +
        ...
        forward.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (questionAttempted > 1 || optionBtnTrue.isPressed() && optionBtnFalse.isPressed()) {
                    ...
                    Toast.makeText(Networking.this, "Please check your answers", Toast.LENGTH_SHORT).show();
                }
            }
        });
        help.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (chance <= 1) {
                    ...
                    Intent intent = new Intent(Networking.this, Help.class);
                    intent.putExtra("help", helpAnswer);
                    startActivity(intent);
                } else {
                    Toast.makeText(Networking.this, "No More chance", Toast.LENGTH_SHORT).show();
    ...
    private void setDataToView(int current) {
        ...
        if (questionAttempted == 10) {
            Intent intent = new Intent(Networking.this, Result.class);
