...
public class ArtificialIntelligenece extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_artificial_intelligenece);
...
//                    questionNumber.setText("Question Attempted:" + questionAttempted + "/10");
                    ...
                    Toast.makeText(ArtificialIntelligenece.this, "No passed Questions" +
        ...
        forward.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(questionAttempted>1||optionBtnTrue.isPressed()&&optionBtnFalse.isPressed()){
                    ...
                    Toast.makeText(ArtificialIntelligenece.this, "Please check your answers", Toast.LENGTH_SHORT).show();
                }
            }
        });
        help.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(chance<=1){
                    ...
                    Intent intent=new Intent(ArtificialIntelligenece.this,Help.class);
                    intent.putExtra("help",helpAnswer);
                    startActivity(intent);
                }else {
                    Toast.makeText(ArtificialIntelligenece.this, "No More chance", Toast.LENGTH_SHORT).show();
    ...
    private void setDataToView(int current) {
        ...
        if (questionAttempted == 10) {
            Intent intent = new Intent(ArtificialIntelligenece.this, Result.class);
