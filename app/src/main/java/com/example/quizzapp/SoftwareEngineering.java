...
//                    questionNumber.setText("Question Attempted:" + questionAttempted + "/10");
                    ...
                    Toast.makeText(SoftwareEngineering.this, "No passed Questions" +
        ...
        forward.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(questionAttempted>1||optionBtnTrue.isPressed()&&optionBtnFalse.isPressed()){
                    ...
                    Toast.makeText(SoftwareEngineering.this, "Please check your answers", Toast.LENGTH_SHORT).show();
                }
            }
        });
        help.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(chance<=1){
                    ...
                    Intent intent=new Intent(SoftwareEngineering.this,Help.class);
                    intent.putExtra("help",helpAnswer);
                    startActivity(intent);
                }else {
                    Toast.makeText(SoftwareEngineering.this, "No More chance", Toast.LENGTH_SHORT).show();
...
//        answer.setText(getCorrectAnswers().trim().toString());
        if (questionAttempted == 10) {
            Intent intent = new Intent(SoftwareEngineering.this, Result.class);
